	...
	; Command: cvbasic --nes space-blast-v034.bas space-blast-v034.asm
...
array_SHVX:	equ $048d
ram_end:
	; BANK ROM 512	' v0.34: textos fixos paginados; gameplay da v0.29 intacto
...
cvb_TE_FIM:
	...
	RTS
	; 
	; 	' v0.34: texto fixo, paginado e com fade-in; os tiles 26/27/28
	; 	' (til/agudo/circunflexo) ficam exatamente sobre a vogal. As paginas
	; 	' usam margem de 16 pixels e nao dependem de scroll de nametable.
...
cv510:
	...
	JMP cvb_HS_RELEASE
cv511:
	; 	' Historia fixa em tres paginas; cada uma fica acesa 5 segundos.
	; 	#fp = 0
	LDA #0
	TAY
	STA cvb_#FP
...
cvb_FIXED_PAGE_SHOW:
	...
	; 	' Margem: colunas 2..29 (16 px laterais); texto/acento entre linhas 2..21.
	; 	sk = 0
	LDA #0
	STA cvb_SK
	; 	SCREEN DISABLE
...
cv518:
	...
	CMP #7
	BCC.L cv515
	; 	' Hold de 300 frames = aproximadamente 5 segundos por pagina.
	; 	' Dividido em dois loops para respeitar o contador de 8 bits do CVBasic.
	; 	FOR r = 0 TO 1
	LDA #0
	STA cvb_R
cv519:
...
cvb_FIXED_TEXT_DATA:
	; 	DATA BYTE 75
	DB $4b
	; 	DATA BYTE 0,3,4,23,79,32,73,77,80,69,82,73,79,32,71,79,82,70,32,65,77,69,65,29,65,32,65
	DB $00,$03,$04,$17,$4f,$20,$49,$4d
	DB $50,$45,$52,$49,$4f,$20,$47,$4f
	DB $52,$46,$20,$41,$4d,$45,$41,$1d
	DB $41,$20,$41
	; 	DATA BYTE 0,2,9,1,27
	DB $00,$02,$09,$01,$1b
	; 	DATA BYTE 0,5,5,21,71,65,76,65,88,73,65,33,32,65,32,72,85,77,65,78,73,68,65,68,69
	DB $00,$05,$05,$15,$47,$41,$4c,$41
	DB $58,$49,$41,$21,$20,$41,$20,$48
	DB $55,$4d,$41,$4e,$49,$44,$41,$44
	DB $45
	; 	DATA BYTE 0,4,8,1,27
	DB $00,$04,$08,$01,$1b
	; 	DATA BYTE 0,7,2,28,80,82,69,67,73,83,65,32,82,69,83,73,83,84,73,82,32,69,32,69,78,70,82,69,78,84,65,82
	DB $00,$07,$02,$1c,$50,$52,$45,$43
	DB $49,$53,$41,$20,$52,$45,$53,$49
	DB $53,$54,$49,$52,$20,$45,$20,$45
	DB $4e,$46,$52,$45,$4e,$54,$41,$52
	; 	DATA BYTE 0,9,3,25,69,83,83,69,32,73,78,73,77,73,71,79,32,84,69,82,82,73,86,69,76,33,32,79,83
	DB $00,$09,$03,$19,$45,$53,$53,$45
	DB $20,$49,$4e,$49,$4d,$49,$47,$4f
	DB $20,$54,$45,$52,$52,$49,$56,$45
	DB $4c,$21,$20,$4f,$53
	; 	DATA BYTE 0,8,20,1,27
	DB $00,$08,$14,$01,$1b
	; 	DATA BYTE 0,11,2,27,76,65,67,65,73,79,83,32,68,69,32,71,79,82,70,32,69,78,67,79,78,84,82,65,82,65,77
	DB $00,$0b,$02,$1b,$4c,$41,$43,$41
	DB $49,$4f,$53,$20,$44,$45,$20,$47
	DB $4f,$52,$46,$20,$45,$4e,$43,$4f
	DB $4e,$54,$52,$41,$52,$41,$4d
	; 	DATA BYTE 0,13,4,23,65,32,84,69,82,82,65,32,69,32,73,78,73,67,73,65,82,65,77,32,85,77,65
	DB $00,$0d,$04,$17,$41,$20,$54,$45
	DB $52,$52,$41,$20,$45,$20,$49,$4e
	DB $49,$43,$49,$41,$52,$41,$4d,$20
	DB $55,$4d,$41
	; 	DATA BYTE 0,15,5,22,71,85,69,82,82,65,46,32,69,77,32,83,69,77,65,78,65,83,44,32,65,83
	DB $00,$0f,$05,$16,$47,$55,$45,$52
	DB $52,$41,$2e,$20,$45,$4d,$20,$53
	DB $45,$4d,$41,$4e,$41,$53,$2c,$20
	DB $41,$53
	; 	DATA BYTE 0,17,5,21,70,79,82,29,65,83,32,68,65,32,84,69,82,82,65,32,69,32,68,79,83
	DB $00,$11,$05,$15,$46,$4f,$52,$1d
	DB $41,$53,$20,$44,$41,$20,$54,$45
	DB $52,$52,$41,$20,$45,$20,$44,$4f
	DB $53
	; 	DATA BYTE 0,19,4,24,73,78,73,77,73,71,79,83,32,83,79,70,82,69,82,65,77,32,77,85,73,84,65,83
	DB $00,$13,$04,$18,$49,$4e,$49,$4d
	DB $49,$47,$4f,$53,$20,$53,$4f,$46
	DB $52,$45,$52,$41,$4d,$20,$4d,$55
	DB $49,$54,$41,$53
	; 	DATA BYTE 1,3,2,27,66,65,73,88,65,83,44,32,77,65,83,32,69,76,69,83,32,69,83,84,65,86,65,77,32,69,77
	DB $01,$03,$02,$1b,$42,$41,$49,$58
	DB $41,$53,$2c,$20,$4d,$41,$53,$20
	DB $45,$4c,$45,$53,$20,$45,$53,$54
	DB $41,$56,$41,$4d,$20,$45,$4d
	; 	DATA BYTE 1,5,3,26,77,65,73,79,82,32,78,85,77,69,82,79,32,69,32,67,79,78,83,69,71,85,73,82,65,77
	DB $01,$05,$03,$1a,$4d,$41,$49,$4f
	DB $52,$20,$4e,$55,$4d,$45,$52,$4f
	DB $20,$45,$20,$43,$4f,$4e,$53,$45
	DB $47,$55,$49,$52,$41,$4d
	; 	DATA BYTE 1,4,10,1,27
	DB $01,$04,$0a,$01,$1b
	; 	DATA BYTE 1,7,3,26,83,73,84,73,65,82,32,78,79,83,83,79,32,80,76,65,78,69,84,65,46,32,67,79,77,79
	DB $01,$07,$03,$1a,$53,$49,$54,$49
	DB $41,$52,$20,$4e,$4f,$53,$53,$4f
	DB $20,$50,$4c,$41,$4e,$45,$54,$41
	DB $2e,$20,$43,$4f,$4d,$4f
	; 	DATA BYTE 1,9,4,23,85,76,84,73,77,79,32,82,69,67,85,82,83,79,44,32,79,83,32,84,82,69,83
	DB $01,$09,$04,$17,$55,$4c,$54,$49
	DB $4d,$4f,$20,$52,$45,$43,$55,$52
	DB $53,$4f,$2c,$20,$4f,$53,$20,$54
	DB $52,$45,$53
	; 	DATA BYTE 1,8,4,1,27
	DB $01,$08,$04,$01,$1b
	; 	DATA BYTE 1,8,25,1,28
	DB $01,$08,$19,$01,$1c
	; 	DATA BYTE 1,11,3,25,77,69,76,72,79,82,69,83,32,80,73,76,79,84,79,83,32,68,65,32,84,69,82,82,65
	DB $01,$0b,$03,$19,$4d,$45,$4c,$48
	DB $4f,$52,$45,$53,$20,$50,$49,$4c
	DB $4f,$54,$4f,$53,$20,$44,$41,$20
	DB $54,$45,$52,$52,$41
	; 	DATA BYTE 1,13,3,26,70,79,82,65,77,32,69,78,86,73,65,68,79,83,32,78,85,77,65,32,77,73,83,83,65,79
	DB $01,$0d,$03,$1a,$46,$4f,$52,$41
	DB $4d,$20,$45,$4e,$56,$49,$41,$44
	DB $4f,$53,$20,$4e,$55,$4d,$41,$20
	DB $4d,$49,$53,$53,$41,$4f
	; 	DATA BYTE 1,12,27,1,26
	DB $01,$0c,$1b,$01,$1a
	; 	DATA BYTE 1,15,5,22,83,85,73,67,73,68,65,32,80,65,82,65,32,79,32,83,73,83,84,69,77,65
	DB $01,$0f,$05,$16,$53,$55,$49,$43
	DB $49,$44,$41,$20,$50,$41,$52,$41
	DB $20,$4f,$20,$53,$49,$53,$54,$45
	DB $4d,$41
	; 	DATA BYTE 1,14,9,1,27
	DB $01,$0e,$09,$01,$1b
	; 	DATA BYTE 1,17,2,27,89,65,82,73,83,44,32,80,65,82,65,32,84,69,78,84,65,82,32,68,69,82,82,79,84,65,82
	DB $01,$11,$02,$1b,$59,$41,$52,$49
	DB $53,$2c,$20,$50,$41,$52,$41,$20
	DB $54,$45,$4e,$54,$41,$52,$20,$44
	DB $45,$52,$52,$4f,$54,$41,$52
	; 	DATA BYTE 1,19,2,27,71,79,82,70,32,69,77,32,83,85,65,32,80,82,79,80,82,73,65,32,67,65,83,65,46,32,65
	DB $01,$13,$02,$1b,$47,$4f,$52,$46
	DB $20,$45,$4d,$20,$53,$55,$41,$20
	DB $50,$52,$4f,$50,$52,$49,$41,$20
	DB $43,$41,$53,$41,$2e,$20,$41
	; 	DATA BYTE 1,18,16,1,27
	DB $01,$12,$10,$01,$1b
	; 	DATA BYTE 1,21,4,23,77,73,83,83,65,79,58,32,65,76,67,65,78,29,65,82,32,89,65,82,73,83,44
	DB $01,$15,$04,$17,$4d,$49,$53,$53
	DB $41,$4f,$3a,$20,$41,$4c,$43,$41
	DB $4e,$1d,$41,$52,$20,$59,$41,$52
	DB $49,$53,$2c
	; 	DATA BYTE 1,20,8,1,26
	DB $01,$14,$08,$01,$1a
	; 	DATA BYTE 2,3,6,20,80,65,83,83,65,82,32,80,79,82,32,86,85,76,67,65,78,44,32,79
	DB $02,$03,$06,$14,$50,$41,$53,$53
	DB $41,$52,$20,$50,$4f,$52,$20,$56
	DB $55,$4c,$43,$41,$4e,$2c,$20,$4f
	; 	DATA BYTE 2,5,4,23,67,73,78,84,85,82,65,79,32,68,69,32,65,83,84,69,82,79,73,68,69,83,44
	DB $02,$05,$04,$17,$43,$49,$4e,$54
	DB $55,$52,$41,$4f,$20,$44,$45,$20
	DB $41,$53,$54,$45,$52,$4f,$49,$44
	DB $45,$53,$2c
	; 	DATA BYTE 2,4,10,1,26
	DB $02,$04,$0a,$01,$1a
	; 	DATA BYTE 2,4,21,1,27
	DB $02,$04,$15,$01,$1b
	; 	DATA BYTE 2,7,5,21,68,69,83,84,82,85,73,82,32,79,32,71,69,82,65,68,79,82,32,68,69
	DB $02,$07,$05,$15,$44,$45,$53,$54
	DB $52,$55,$49,$52,$20,$4f,$20,$47
	DB $45,$52,$41,$44,$4f,$52,$20,$44
	DB $45
	; 	DATA BYTE 2,9,4,24,69,83,67,85,68,79,83,32,69,77,32,65,84,76,65,78,84,73,83,32,80,65,82,65
	DB $02,$09,$04,$18,$45,$53,$43,$55
	DB $44,$4f,$53,$20,$45,$4d,$20,$41
	DB $54,$4c,$41,$4e,$54,$49,$53,$20
	DB $50,$41,$52,$41
	; 	DATA BYTE 2,11,2,28,67,72,69,71,65,82,32,65,32,71,79,82,70,70,73,79,78,32,69,32,68,69,83,84,82,85,73,82
	DB $02,$0b,$02,$1c,$43,$48,$45,$47
	DB $41,$52,$20,$41,$20,$47,$4f,$52
	DB $46,$46,$49,$4f,$4e,$20,$45,$20
	DB $44,$45,$53,$54,$52,$55,$49,$52
	; 	DATA BYTE 2,13,2,28,71,79,82,70,32,69,77,32,83,85,65,32,66,65,83,69,33,32,66,79,65,32,83,79,82,84,69,44
	DB $02,$0d,$02,$1c,$47,$4f,$52,$46
	DB $20,$45,$4d,$20,$53,$55,$41,$20
	DB $42,$41,$53,$45,$21,$20,$42,$4f
	DB $41,$20,$53,$4f,$52,$54,$45,$2c
	; 	DATA BYTE 2,15,2,28,86,79,67,69,83,32,83,65,79,32,65,32,85,76,84,73,77,65,32,69,83,80,69,82,65,78,29,65
	DB $02,$0f,$02,$1c,$56,$4f,$43,$45
	DB $53,$20,$53,$41,$4f,$20,$41,$20
	DB $55,$4c,$54,$49,$4d,$41,$20,$45
	DB $53,$50,$45,$52,$41,$4e,$1d,$41
	; 	DATA BYTE 2,14,5,1,28
	DB $02,$0e,$05,$01,$1c
	; 	DATA BYTE 2,14,9,1,26
	DB $02,$0e,$09,$01,$1a
	; 	DATA BYTE 2,14,14,1,27
	DB $02,$0e,$0e,$01,$1b
	; 	DATA BYTE 2,17,11,9,68,65,32,84,69,82,82,65,33
	DB $02,$11,$0b,$09,$44,$41,$20,$54
	DB $45,$52,$52,$41,$21
	; 	DATA BYTE 3,3,6,20,81,85,69,77,32,70,69,90,32,83,80,65,67,69,32,66,76,65,83,84
	DB $03,$03,$06,$14,$51,$55,$45,$4d
	DB $20,$46,$45,$5a,$20,$53,$50,$41
	DB $43,$45,$20,$42,$4c,$41,$53,$54
	; 	DATA BYTE 3,5,2,27,80,82,79,71,82,65,77,65,29,65,79,58,32,83,65,85,76,79,32,83,65,78,84,73,65,71,79
	DB $03,$05,$02,$1b,$50,$52,$4f,$47
	DB $52,$41,$4d,$41,$1d,$41,$4f,$3a
	DB $20,$53,$41,$55,$4c,$4f,$20,$53
	DB $41,$4e,$54,$49,$41,$47,$4f
	; 	DATA BYTE 3,4,11,1,26
	DB $03,$04,$0b,$01,$1a
	; 	DATA BYTE 3,7,4,24,71,82,65,70,73,67,79,83,58,32,83,65,85,76,79,32,83,65,78,84,73,65,71,79
	DB $03,$07,$04,$18,$47,$52,$41,$46
	DB $49,$43,$4f,$53,$3a,$20,$53,$41
	DB $55,$4c,$4f,$20,$53,$41,$4e,$54
	DB $49,$41,$47,$4f
	; 	DATA BYTE 3,6,6,1,27
	DB $03,$06,$06,$01,$1b
	; 	DATA BYTE 3,9,5,21,65,85,68,73,79,58,32,83,65,85,76,79,32,83,65,78,84,73,65,71,79
	DB $03,$09,$05,$15,$41,$55,$44,$49
	DB $4f,$3a,$20,$53,$41,$55,$4c,$4f
	DB $20,$53,$41,$4e,$54,$49,$41,$47
	DB $4f
	; 	DATA BYTE 3,11,6,19,80,82,79,68,85,29,65,79,58,32,76,77,83,32,82,69,84,82,79
	DB $03,$0b,$06,$13,$50,$52,$4f,$44
	DB $55,$1d,$41,$4f,$3a,$20,$4c,$4d
	DB $53,$20,$52,$45,$54,$52,$4f
	; 	DATA BYTE 3,10,12,1,26
	DB $03,$0a,$0c,$01,$1a
	; 	DATA BYTE 3,13,4,23,80,85,66,76,73,67,65,29,65,79,58,32,70,65,76,67,79,78,32,83,79,70,84
	DB $03,$0d,$04,$17,$50,$55,$42,$4c
	DB $49,$43,$41,$1d,$41,$4f,$3a,$20
	DB $46,$41,$4c,$43,$4f,$4e,$20,$53
	DB $4f,$46,$54
	; 	DATA BYTE 3,12,12,1,26
	DB $03,$0c,$0c,$01,$1a
	; 	DATA BYTE 3,15,2,27,84,69,83,84,69,83,58,32,77,65,82,67,79,83,32,70,69,76,73,80,69,44,32,76,85,67,65
	DB $03,$0f,$02,$1b,$54,$45,$53,$54
	DB $45,$53,$3a,$20,$4d,$41,$52,$43
	DB $4f,$53,$20,$46,$45,$4c,$49,$50
	DB $45,$2c,$20,$4c,$55,$43,$41
	; 	DATA BYTE 3,17,5,22,86,79,76,79,84,65,79,44,32,76,85,67,65,83,32,77,85,78,72,79,90,44
	DB $03,$11,$05,$16,$56,$4f,$4c,$4f
	DB $54,$41,$4f,$2c,$20,$4c,$55,$43
	DB $41,$53,$20,$4d,$55,$4e,$48,$4f
	DB $5a,$2c
	; 	DATA BYTE 3,16,10,1,26
	DB $03,$10,$0a,$01,$1a
	; 	DATA BYTE 3,19,8,16,70,73,76,73,80,69,32,71,82,65,67,73,79,76,76,73
	DB $03,$13,$08,$10,$46,$49,$4c,$49
	DB $50,$45,$20,$47,$52,$41,$43,$49
	DB $4f,$4c,$4c,$49
	; 	DATA BYTE 4,3,3,25,65,71,82,65,68,69,67,73,77,69,78,84,79,83,32,69,83,80,69,67,73,65,73,83,58
	DB $04,$03,$03,$19,$41,$47,$52,$41
	DB $44,$45,$43,$49,$4d,$45,$4e,$54
	DB $4f,$53,$20,$45,$53,$50,$45,$43
	DB $49,$41,$49,$53,$3a
	; 	DATA BYTE 4,5,5,21,87,65,82,80,90,79,78,69,44,32,67,65,78,65,76,51,44,32,82,73,79
	DB $04,$05,$05,$15,$57,$41,$52,$50
	DB $5a,$4f,$4e,$45,$2c,$20,$43,$41
	DB $4e,$41,$4c,$33,$2c,$20,$52,$49
	DB $4f
	; 	DATA BYTE 4,7,2,28,82,69,84,82,79,71,65,77,69,83,44,32,83,72,77,85,80,83,66,82,44,32,77,65,82,67,79,83
	DB $04,$07,$02,$1c,$52,$45,$54,$52
	DB $4f,$47,$41,$4d,$45,$53,$2c,$20
	DB $53,$48,$4d,$55,$50,$53,$42,$52
	DB $2c,$20,$4d,$41,$52,$43,$4f,$53
	; 	DATA BYTE 4,9,4,23,70,69,76,73,80,69,44,32,82,65,70,65,69,76,32,76,73,77,65,44,32,80,86
	DB $04,$09,$04,$17,$46,$45,$4c,$49
	DB $50,$45,$2c,$20,$52,$41,$46,$41
	DB $45,$4c,$20,$4c,$49,$4d,$41,$2c
	DB $20,$50,$56
	; 	DATA BYTE 4,11,2,27,82,65,68,84,75,69,44,32,89,85,82,73,32,68,65,86,73,76,65,44,32,84,72,73,65,71,79
	DB $04,$0b,$02,$1b,$52,$41,$44,$54
	DB $4b,$45,$2c,$20,$59,$55,$52,$49
	DB $20,$44,$41,$56,$49,$4c,$41,$2c
	DB $20,$54,$48,$49,$41,$47,$4f
	; 	DATA BYTE 4,10,16,1,27
	DB $04,$0a,$10,$01,$1b
	; 	DATA BYTE 4,13,5,22,77,73,78,69,73,82,79,44,32,76,85,67,65,83,32,77,85,78,72,79,90,44
	DB $04,$0d,$05,$16,$4d,$49,$4e,$45
	DB $49,$52,$4f,$2c,$20,$4c,$55,$43
	DB $41,$53,$20,$4d,$55,$4e,$48,$4f
	DB $5a,$2c
	; 	DATA BYTE 4,15,3,26,71,85,83,84,65,86,79,32,86,65,76,68,73,86,73,69,83,83,79,44,32,77,65,82,73,79
	DB $04,$0f,$03,$1a,$47,$55,$53,$54
	DB $41,$56,$4f,$20,$56,$41,$4c,$44
	DB $49,$56,$49,$45,$53,$53,$4f,$2c
	DB $20,$4d,$41,$52,$49,$4f
	; 	DATA BYTE 4,17,3,25,78,69,83,82,79,67,75,83,44,32,67,65,82,73,78,65,32,86,79,76,79,84,65,79,44
	DB $04,$11,$03,$19,$4e,$45,$53,$52
	DB $4f,$43,$4b,$53,$2c,$20,$43,$41
	DB $52,$49,$4e,$41,$20,$56,$4f,$4c
	DB $4f,$54,$41,$4f,$2c
	; 	DATA BYTE 4,16,25,1,26
	DB $04,$10,$19,$01,$1a
	; 	DATA BYTE 5,3,2,28,76,85,67,65,32,69,32,82,65,86,73,44,32,84,79,68,79,83,32,79,83,32,65,77,73,71,79,83
	DB $05,$03,$02,$1c,$4c,$55,$43,$41
	DB $20,$45,$20,$52,$41,$56,$49,$2c
	DB $20,$54,$4f,$44,$4f,$53,$20,$4f
	DB $53,$20,$41,$4d,$49,$47,$4f,$53
	; 	DATA BYTE 5,5,3,25,81,85,69,32,83,69,77,80,82,69,32,65,67,82,69,68,73,84,65,82,65,77,32,78,65
	DB $05,$05,$03,$19,$51,$55,$45,$20
	DB $53,$45,$4d,$50,$52,$45,$20,$41
	DB $43,$52,$45,$44,$49,$54,$41,$52
	DB $41,$4d,$20,$4e,$41
	; 	DATA BYTE 5,7,4,23,70,65,76,67,79,78,32,83,79,70,84,32,69,32,86,79,67,69,44,32,81,85,69
	DB $05,$07,$04,$17,$46,$41,$4c,$43
	DB $4f,$4e,$20,$53,$4f,$46,$54,$20
	DB $45,$20,$56,$4f,$43,$45,$2c,$20
	DB $51,$55,$45
	; 	DATA BYTE 5,6,21,1,28
	DB $05,$06,$15,$01,$1c
	; 	DATA BYTE 5,9,3,25,80,82,69,83,84,73,71,73,79,85,32,78,79,83,83,79,32,84,82,65,66,65,76,72,79
	DB $05,$09,$03,$19,$50,$52,$45,$53
	DB $54,$49,$47,$49,$4f,$55,$20,$4e
	DB $4f,$53,$53,$4f,$20,$54,$52,$41
	DB $42,$41,$4c,$48,$4f
	; 	DATA BYTE 5,11,3,26,86,73,83,73,84,69,32,65,32,70,65,76,67,79,78,83,79,70,84,46,67,79,77,46,66,82
	DB $05,$0b,$03,$1a,$56,$49,$53,$49
	DB $54,$45,$20,$41,$20,$46,$41,$4c
	DB $43,$4f,$4e,$53,$4f,$46,$54,$2e
	DB $43,$4f,$4d,$2e,$42,$52
	; 	DATA BYTE 5,13,4,23,80,65,82,65,32,78,79,86,79,83,32,74,79,71,79,83,32,65,80,79,73,69,77
	DB $05,$0d,$04,$17,$50,$41,$52,$41
	DB $20,$4e,$4f,$56,$4f,$53,$20,$4a
	DB $4f,$47,$4f,$53,$20,$41,$50,$4f
	DB $49,$45,$4d
	; 	DATA BYTE 5,15,5,21,83,69,77,80,82,69,32,79,83,32,73,78,68,73,69,32,71,65,77,69,83
	DB $05,$0f,$05,$15,$53,$45,$4d,$50
	DB $52,$45,$20,$4f,$53,$20,$49,$4e
	DB $44,$49,$45,$20,$47,$41,$4d,$45
	DB $53
	; 	DATA BYTE 5,17,10,12,66,82,65,83,73,76,69,73,82,79,83,33
	DB $05,$11,$0a,$0c,$42,$52,$41,$53
