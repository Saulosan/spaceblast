...
; Intruder Alert v0.36: initialize boss music after scenery transition.
...
FORG $0C010
ORG $8000
INCLUDE "../../music-integration/famistudio_engine_gasm80.asm"
INCLUDE "../../music-integration/intruder_alert_data_gasm80.asm"
TIMES $BFFF-$ DB $FF
DB $03
