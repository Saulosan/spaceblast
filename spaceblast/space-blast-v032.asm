	...
	; Command: cvbasic --nes space-blast-v032.bas space-blast-v032.asm
...
array_SHVX:	equ $0485
ram_end:
	; BANK ROM 512	' v0.32: correcao do scroll de textos; gameplay da v0.29 intacto
...
cvb_TE_FIM:
	...
	RTS
	; 
	; 	' v0.32: cada linha usa uma linha vazia acima; os tiles 26/27/28
