	...
	; Command: ../cvbasic-repo/cvbasic --nes space-blast-dbg.bas space-blast-dbg.asm 
	; Created: Fri Jul 31 23:58:12 2026
...
ram_end:
	...
	; 	DIM diag(40),bkc,h,#db		' v0.24-dbg: pericia do tile $00/$20 (bug das estrelas)	' v0.23: fase atual, anel lava=linha-
...
cv13:
	...
	; 		' slots com tile 0); zera as duas paginas (proc mora no banco 3)
	; 		BANK SELECT 1
	TYA
	ORA CHRRAM_BANK
	STA BANKSEL
...
cv438:
	...
	STA scroll_y
	STY scroll_y+1
	; 	PRINT AT 460,"FASE 01"
	JSR print_string_cursor_constant
	DB $cc,$01,$07
	DB $46,$41,$53,$45,$20,$30,$31
	; 	PRINT AT 514,"A CAMINHO DO PLANETA DE FOGO"
	JSR print_string_cursor_constant
	DB $02,$02,$1c
...
cv461:
	...
	JSR print_string_cursor_constant
	DB $88,$01,$10
	DB $46,$41,$53,$45,$20,$30,$31,$20
	DB $43,$4f,$4d,$50,$4c,$45,$54,$41
...
cv473:
	...
	JSR print_string_cursor_constant
	DB $cc,$01,$07
	DB $46,$41,$53,$45,$20,$30,$32
	; 	PRINT AT 520,"PLANETA DE LAVA"
	JSR print_string_cursor_constant
	DB $08,$02,$0f
	DB $50,$4c,$41,$4e,$45,$54,$41,$20
	DB $44,$45,$20,$4c,$41,$56,$41
	; 	VPOKE $3F01,$0F
	LDA #15
	PHA
	LDA #1
...
cvb_DIAG_DUMP_GO:
	...
	; diag_core:
cvb_DIAG_CORE:
	; 	' --- SELFTEST (NAO VAI P/ PRODUCAO): injeta o par 08/28 ---
	; 	FOR i = 0 TO 15
	LDA #0
	STA cvb_I
cv483:
	...
	; 	WAIT
	JSR wait
	; 	bkc = PEEK(28)		' sombra CHR-RAM (NMI faz ORA CHRRAM_BANK/BANKSEL)
	LDA #28
	LDY #0
	JSR _peek8
	STA cvb_BKC
 ...
 LDA $2007
	; 	ASM LDA $2007
 LDA $2007
	; 	ASM STA array_DIAG+0
 STA array_DIAG+0
	; 	ASM LDA $2007
 LDA $2007
	; 	ASM STA array_DIAG+1
 STA array_DIAG+1
	; 	ASM LDA $2007
 LDA $2007
	; 	ASM STA array_DIAG+2
 STA array_DIAG+2
	; 	ASM LDA $2007
 LDA $2007
	; 	ASM STA array_DIAG+3
 STA array_DIAG+3
	; 	ASM LDA $2007
 LDA $2007
	; 	ASM STA array_DIAG+4
 STA array_DIAG+4
	; 	ASM LDA $2007
 LDA $2007
	; 	ASM STA array_DIAG+5
 STA array_DIAG+5
	; 	ASM LDA $2007
 LDA $2007
	; 	ASM STA array_DIAG+6
 STA array_DIAG+6
	; 	ASM LDA $2007
 LDA $2007
	; 	ASM STA array_DIAG+7
 STA array_DIAG+7
	; 	ASM LDA $2007
 LDA $2007
	; 	ASM STA array_DIAG+8
 STA array_DIAG+8
	; 	ASM LDA $2007
 LDA $2007
	; 	ASM STA array_DIAG+9
 STA array_DIAG+9
	; 	ASM LDA $2007
 LDA $2007
	; 	ASM STA array_DIAG+10
 STA array_DIAG+10
	; 	ASM LDA $2007
 LDA $2007
	; 	ASM STA array_DIAG+11
 STA array_DIAG+11
	; 	ASM LDA $2007
 LDA $2007
	; 	ASM STA array_DIAG+12
 STA array_DIAG+12
	; 	ASM LDA $2007
 LDA $2007
	; 	ASM STA array_DIAG+13
 STA array_DIAG+13
	; 	ASM LDA $2007
 LDA $2007
	; 	ASM STA array_DIAG+14
 STA array_DIAG+14
	; 	ASM LDA $2007
 LDA $2007
	; 	ASM STA array_DIAG+15
 STA array_DIAG+15
	; 	ASM LDA #$02
 LDA #$02
	; 	ASM STA $2006
 ...
 LDA $2007
	; 	ASM LDA $2007
 LDA $2007
	; 	ASM STA array_DIAG+16
 STA array_DIAG+16
	; 	ASM LDA $2007
 LDA $2007
	; 	ASM STA array_DIAG+17
 STA array_DIAG+17
	; 	ASM LDA $2007
 LDA $2007
	; 	ASM STA array_DIAG+18
 STA array_DIAG+18
	; 	ASM LDA $2007
 LDA $2007
	; 	ASM STA array_DIAG+19
 STA array_DIAG+19
	; 	ASM LDA $2007
 LDA $2007
	; 	ASM STA array_DIAG+20
 STA array_DIAG+20
	; 	ASM LDA $2007
 LDA $2007
	; 	ASM STA array_DIAG+21
 STA array_DIAG+21
	; 	ASM LDA $2007
 LDA $2007
	; 	ASM STA array_DIAG+22
 STA array_DIAG+22
	; 	ASM LDA $2007
 LDA $2007
	; 	ASM STA array_DIAG+23
 STA array_DIAG+23
	; 	ASM LDA $2007
 LDA $2007
	; 	ASM STA array_DIAG+24
 STA array_DIAG+24
	; 	ASM LDA $2007
 LDA $2007
	; 	ASM STA array_DIAG+25
 STA array_DIAG+25
	; 	ASM LDA $2007
 LDA $2007
	; 	ASM STA array_DIAG+26
 STA array_DIAG+26
	; 	ASM LDA $2007
 LDA $2007
	; 	ASM STA array_DIAG+27
 STA array_DIAG+27
	; 	ASM LDA $2007
 LDA $2007
	; 	ASM STA array_DIAG+28
 STA array_DIAG+28
	; 	ASM LDA $2007
 LDA $2007
	; 	ASM STA array_DIAG+29
 STA array_DIAG+29
	; 	ASM LDA $2007
 LDA $2007
	; 	ASM STA array_DIAG+30
 STA array_DIAG+30
	; 	ASM LDA $2007
 LDA $2007
	; 	ASM STA array_DIAG+31
 STA array_DIAG+31
	; 	ASM LDA #$20
 LDA #$20
	; 	ASM STA $2006
 ...
 LDA $2007
	; 	ASM LDA $2007
 LDA $2007
	; 	ASM STA array_DIAG+32
 STA array_DIAG+32
	; 	ASM LDA $2007
 LDA $2007
	; 	ASM STA array_DIAG+33
 STA array_DIAG+33
	; 	ASM LDA $2007
 LDA $2007
	; 	ASM STA array_DIAG+34
 STA array_DIAG+34
	; 	ASM LDA $2007
 LDA $2007
	; 	ASM STA array_DIAG+35
 STA array_DIAG+35
	; 	ASM LDA #$A8
 LDA #$A8
	; 	ASM STA $2000
